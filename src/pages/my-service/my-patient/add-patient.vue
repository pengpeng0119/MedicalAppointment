<template>
    <view class="AI-card">
        <image src="/static/other/AI-shibie.svg" mode="widthFix" @click="upload"></image>
        <text>身份证智能识别</text>
    </view>
    <view class="xinguan-view">
        <view class="xinguan-flex">
            <text>请输入姓名</text>
            <input placeholder="请输入姓名" placeholder-class="input-style" v-model="submitData.name" />
        </view>
        <view class="xinguan-flex">
            <text>性别</text>
            <picker mode="selector" class="flex-left" @change="changeGender" :range="['男', '女']">
                <view>
                    <text>
        ...
        <view class="xinguan-flex">
            <text>成员关系</text>
            <picker mode="selector" class="flex-left" :range="['自己', '父母', '其他']" @change="changeTem">
                <view>
                    <text>
        ...
        <view class="xinguan-flex">
            <text>请输入身份证</text>
            <input placeholder="请输入身份证" placeholder-class="input-style" type="number" v-model="submitData.id_card" />
        </view>
        <view class="xinguan-flex">
            <text>请输入手机号</text>
